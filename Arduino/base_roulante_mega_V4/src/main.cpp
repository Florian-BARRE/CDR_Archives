...
Action action0 = create_action_bis(0.0, 0.0);
Action action1 = create_action_bis(50.0, 0.0);
Action action2 = create_action_bis(50.0, 10.0);
Action action3 = create_action_bis(0.0, 10.0);
