...
Action action0 = create_action(130.0, 0.0  , NEXT_POSITION_DELAY, ACTION_ERROR_AUTH);
Action action1 = create_action(130.0, 47.0, NEXT_POSITION_DELAY, ACTION_ERROR_AUTH);
