...
Action create_action(float obj_x, float obj_y, unsigned int precision_cpt, unsigned int error_auth, byte max_pwm = 0, float obj_theta = CLASSIC_ANGLE)
{
    Action new_action;
