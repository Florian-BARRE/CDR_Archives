...
#define STOP_MOTORS_DELAY 90000
...
Action action0 = create_action(140.0, 0.0  , NEXT_POSITION_DELAY, ACTION_ERROR_AUTH);
Action action1 = create_action(140.0, -47.0, NEXT_POSITION_DELAY, ACTION_ERROR_AUTH);
Action action2 = create_action(230.0, -47.0, NEXT_POSITION_DELAY, ACTION_ERROR_AUTH);
Action action3 = create_action(0.0, 0.0 , NEXT_POSITION_DELAY, ACTION_ERROR_AUTH);
/*
