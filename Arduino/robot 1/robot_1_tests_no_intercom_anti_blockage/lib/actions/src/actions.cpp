...
{
    unsigned int precision_cpt = 400;
    unsigned int error_auth = 40;
    unsigned int antistatic_trigger = 1000;
    ...
    new_action.antistatic_cpt = 0;
    new_action.antistatic_trigger = antistatic_trigger;
