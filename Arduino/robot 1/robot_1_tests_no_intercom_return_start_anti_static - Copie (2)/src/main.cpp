...
Action action1 = create_action(-20.0, -20.0 , NEXT_POSITION_DELAY, ACTION_ERROR_AUTH);
Action action2 = create_action(0.0, 0.0, NEXT_POSITION_DELAY, ACTION_ERROR_AUTH);
/*
