...
Action create_action(float obj_x, float obj_y, unsigned int precision_cpt, unsigned int error_auth, bool backward = false, float obj_theta = CLASSIC_ANGLE)
{
    Action new_action;
